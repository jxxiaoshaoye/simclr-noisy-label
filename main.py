...
def main(_run, _log):
    ...
    args.out_dir=str(args.net)+'/'+str(args.optimizer)+str(args.learning_rate)+'decay/'
    ...
    if args.dataset == "STL10":
        ...
        test_dataset=torchvision.datasets.CIFAR10(
            root, download=True,train=False, transform=TransformsSimCLR(size=32)
        )
    ...
    train_finetune_loader = torch.utils.data.DataLoader(
        ...
        batch_size=args.batch_size, 
        shuffle=True) 
    test_finetune_loader = torch.utils.data.DataLoader(
